  ...
  return (
    <div className={`fixed inset-0 z-[200] grid place-items-center bg-white dark:bg-[#080d18] ${done ? "loader-fade" : ""}`}>
      <div className="flex flex-col items-center gap-5">
        ...
        <div className="font-display text-xl font-bold tracking-tight text-[var(--text)]">
          Saher<span className="gradient-text">Pharma</span>
        </div>
        <div className="line-load h-[2px] rounded-full bg-gradient-to-r from-teal-600 to-teal-400" />
      </div>
    </div>
  );
}
